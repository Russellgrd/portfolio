    ...
    return(
        <div className="About">
            <div className="AboutImageBox">
                <img className="AboutImageBox-img" src={banner} alt="banner of colors"/>
            </div>
